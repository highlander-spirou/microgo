...
from errors import Error, Code, DatabaseError 
...
class UserAuthentication:
    ...
    def sign_user(self, username:str, pwd:str):
        ...
        if result is None:
            return Error(Code.User_notfound, 'User information mismatch')
    ...
    def validate_signature(self, sig:str):
        try:
            ...
            return Error(Code.JWT_Error, 'Failed to validate token, please login again')